        ...
        <Flex w="100vw" mt="52" borderTop="0.25rem solid #915CF3" flexDir="column">
            <Container maxW={["22rem","90rem"]} margin="auto" padding="2.5 16">
                <Flex padding="4.375rem 0 3.125rem 0" justify="space-between" align="center" flexDir={["column", "row"]}>
                    ...
                    <a href="https://api.whatsapp.com/send/?phone=556291306563&text&type=phone_number&app_absent=0" rel="noreferrer" target="_blank"><Button mt={["4rem","0"]} size="lg" colorScheme="purple">FAÇA PARTE</Button></a>
                </Flex>
            </Container>
