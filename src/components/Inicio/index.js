...
const Inicio = () => {
    ...
    return (
        <Flex w="100vw">
        <Container  maxW="75rem" margin="auto" padding="2.5 16">
            <Flex mt="40" align="center" justify="space-between">
                <Flex h="37.5rem" align="start" justify="start" flexDirection="column">
                    ...
                    <Text textShadow="0px 5px 4px #340C7D" mt="3" fontWeight="600" fontSize="3xl" color="branco_escuro">CHAPA <span style={{color: '#915CF3'}}>LOVELACE</span></Text>
