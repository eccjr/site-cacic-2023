...
const Inicio = () => {
    ...
    return (
        ...
        >
            <Flex mt={["32","40"]} align="center" justify="space-between" flexDir={["column","row"]}>
                <Flex w={["100vw","24vw"]} h={["10rem","37.5rem"]} align={["center","start"]} justify={["center","start"]} flexDirection="column">
                ...
                <Flex mt={["3.75rem","0"]} align="center" justify={[ "center","right"]} >
                    <Image boxSize={["17.5rem","37.5rem"]} borderRadius="50%"  src="./image_1.png" alt="Love Lance"/>
                </Flex>
                {isWideVersion ? "" : <ScrollLink to="sobre" offset={-200} >
                        <Button mt={["16","10"]}>Saber mais</Button>
                    </ScrollLink>}
            </Flex>
        </Container>
        </Flex>
