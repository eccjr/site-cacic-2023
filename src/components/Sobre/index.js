        ...
        <Flex id="sobre" w="100vw" mt="11.25rem">
            <Container  maxW={["22rem","90rem"]} margin="auto" padding="2.5 16">
                <Flex flexDir="column" align="center" justify="center">
                    ...
                    <Flex w="100%" mt="20" flexDir={["column","row"]} align="center" justify="space-between">
                        ...
                        <Flex padding="0 20px 0 20px" w={["21rem","25rem"]} mt={["10","0"]} h="31.25rem" background="cinza.35" flexDir="column" align="start" justify="space-evenly">
