      ...
      <Flex
        ...
        backgroundImage={
          [
            ...
            "radial-gradient(28rem 28rem at 13% 5%, rgba(145, 92, 243, 0.33) 0%, rgba(145, 92, 243, 0) 100%), radial-gradient(30rem 30rem at 94% 20%, rgba(145, 92, 243, 0.33) 0%, rgba(145, 92, 243, 0) 100%), radial-gradient(25rem 25rem at 0% 40%, rgba(145, 92, 243, 0.17) 0%, rgba(145, 92, 243, 0) 100%), radial-gradient(30rem 30rem at 95% 60%, rgba(145, 92, 243, 0.33) 0%, rgba(145, 92, 243, 0) 100%), radial-gradient(25rem 25rem at 2% 85%, rgba(145, 92, 243, 0.33) 0%, rgba(145, 92, 243, 0) 100%)"
          ]
        }
        overflow="hidden"
        zIndex="50"
